 ...
 * 各配置信息
 */
package com.railway.ticket.client.config;
...
public class Config implements Serializable {
	...
	/*** 一次最大乘客数*/
	public static int MAXPASSENGER = 5;
	
	// : URL设置 - START
	/*** 网站HOST设置 http[s]://dynamic.12306.cn*/
	public static String HOST = "https://dynamic.12306.cn";
	/*** 登录验证码*/
	public static String LOGIN_CODE_URL = "/otsweb/passCodeAction.do?rand=lrand";
	/*** 用户登录*/
	public static String LOGIN_URL = "/otsweb/loginAction.do?";
	/***单程车票预订查询*/
	public static String ORDER_SINGLE_URL = "/otsweb/order/querySingleAction.do?";
	/*** 订单提交验证码*/
	public static String ORDER_CODE_URL = "/otsweb/passCodeAction.do?rand=randp";
	/*** 订单提交*/
	public static String ORDER_SUBMIT_URL = "/otsweb/order/confirmPassengerAction.do?method=confirmPassengerInfoSingle";
	/*** 订单取消*/
	public static String ORDER_CANCEL_URL = "/otsweb/order/payConfirmOnlineSingleAction.do?method=cancelOrder";
	/*** 订单查询*/
	public static String ORDER_QUERY_URL = "/otsweb/order/myOrderAction.do?";
	/*** 常用联系人信息维护*/
	public static String CONTACT_MAINTAIN_URL = "/otsweb/passengerAction.do?";
	/*** 用户个人信息维护*/
	public static String USER_MAINTAIN_URL = "/otsweb/userCenterAction.do?";
	// :~ URl设置 - END
	
	/*** 车站信息*/
	public static Map<String, String> STATION_MAP = new HashMap<String, String>();
	/*** 座位类型*/
	public static Map<String, String> SEATTYPE_MAP = new HashMap<String, String>();
	...
	/***代理认证用户名*/
	public static String PROXY_AUTH_USERNAME = "anonymous";
	/***代理认证密码*/
	public static String PROXY_AUTH_PASSWORD = "";
	//
	//:~网络设置 - END
	
	/***打开支付网关页面*/
	public static boolean OPEN_EPAY_GATEWAY = false;
	 ...
	 * 获取车站代码
	 * @param station 车站名称
	 * @return 该车站代码,未找到匹配时返回<code>null</code>
	 */
	public static String getStationCode(String station) {
		return STATION_MAP.get(station);
	}
	 ...
	 * @return 值或名称
	 */
	public static String getSeatType(String type) {
		String value = SEATTYPE_MAP.get(type);
		if(null == value) {
			Set<Map.Entry<String, String>> type_set = SEATTYPE_MAP.entrySet();
			for (Map.Entry<String, String> entry : type_set) {
